...
function App() {
  ...
  const printerNames = ["프린터 A", "프린터 B", "프린터 C", "프린터 D"];
    ...
    <div className="app">
      ...
      <div className="nav">
        ...
        <div
          ...
          onClick={() => {
            if (isLoggedIn) movePage("reserve");
          }}
        >
          예약
        </div>
      ...
      {page === "login" && (
        <div className="login-area">
          ...
          <div className="login-links">
            <span className="signup-link" onClick={() => movePage("signup")}>
              회원 가입
            </span>

            <span
              className="findpw-link"
              onClick={() => movePage("findPassword")}
            >
              비밀번호 찾기
            </span>
          </div>
            ...
            <div className="printer-grid">
              {printers.map((status, index) => (
                <div className="printer-item" key={index}>
                  <div className="printer-name">{printerNames[index]}</div>
        ...
        <div className="mypage-area">
          ...
          <div className="using-printer-area">
            ...
            {currentPrinter === null ? (
              ...
              <>
                <div className="using-printer-card using">
                  사용중...
                </div>

                <div className="using-printer-pill-wrap">
                  <img
                    src={usingPrinterPill}
                    className="using-printer-pill"
                    alt=""
                  />

                  <img
                    src={usingPrinterDot}
                    className="using-printer-dot left"
                    alt=""
                  />

                  <img
                    src={usingPrinterDot}
                    className="using-printer-dot right"
                    alt=""
                  />

                  <div className="using-printer-pill-text">
                    <p>2층 소프트웨어 3D프린터</p>
                    <p>n번 프린터</p>
                  </div>
                </div>
        ...
        <div className="account-area">
          ...
          <div className="account-row account-password-row">
            ...
            <img
              ...
              className="account-arrow"
              alt=""
              onClick={() => movePage("changePassword")}
            />
          </div>
      ...
      {page === "findPassword" && (
        <div className="findpw-area">
          ...
          <button className="findpw-button" onClick={() => movePage("verifyCode")}>
            확인
          </button>
        </div>
      )}
